			...
			<nav class="top-header__navigation navigation-top-header">
				<ul class="navigation-top-header__list">
					<li class="navigation-top-header__item">
						<a href="#" class="navigation-top-header__link">Войти</a>
					</li>
					<li class="navigation-top-header__item">
			...
			<main class="page">
				...
				<section class="catalog">
					<div class="catalog__container _container">
						<div class="catalog__content">
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">NFC Брелки</p>
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">NFC Ридеры</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">NFC стикеры</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">RFID карты</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">RFID Брелки</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">RFID метки</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
							...
							<a href="#" class="catalog__item">
								<div class="catalog__info">
									<p class="catalog__name">RFID браслеты</p>
									<p class="catalog__goto">В каталог</p>
								</div>
								<div class="catalog__image">
						...
						<a href="#" class="catalog__more">Смотреть весь каталог</a>
					</div>
				</section>
				<section class="specials">
					<div class="specials__container _container">
						<h2 class="specials__title _title">Специальное предложение</h2>
				...
				<section class="mini-blog">
					<div class="mini-blog__container _container">
						<div class="mini-blog__head">
							<h2 class="mini-blog__title _title">Блог</h2>
							<a href="#" class="mini-blog__more">Все статьи</a>
						</div>
						<div class="mini-blog__content">
							<div class="mini-blog__item item-blog">
								...
								<div class="item-blog__body">
									<a href="#" class="item-blog__name">КАК ЗАПИСАТЬ NFC МЕТКУ С ПОМОЩЬЮ СМАРТФОНА </a>
									<a href="#" class="item-blog__more">Читать</a>
								</div>
							</div>
							<div class="mini-blog__item item-blog">
								<a href="#" class="item-blog__image">
								...
								<div class="item-blog__body">
									<a href="#" class="item-blog__name">КАК ЗАПИСАТЬ НЕСКОЛЬКО ССЫЛОК НА ОДНУ NFC МЕТКУ</a>
									<a href="#" class="item-blog__more">Читать</a>
								</div>
							</div>
							<div class="mini-blog__item item-blog">
								...
								<div class="item-blog__body">
									<a href="#" class="item-blog__name">Что такое NFC для чайников</a>
									<a href="#" class="item-blog__more">Читать</a>
								</div>
							</div>
							<div class="mini-blog__item item-blog">
								...
								<div class="item-blog__body">
									<a href="#" class="item-blog__name">ТОП-8 ПРИЧИН, ПОЧЕМУ НЕ РАБОТАЕТ RFID</a>
									<a href="#" class="item-blog__more">Читать</a>
								</div>
							</div>
						</div>
