					...
					<div class="menu__content">
						...
						<div class="menu__body">
							...
							<div class="menu__contacts contacts-menu">
								...
								<a href="mailto:info@mscards.ro" class="contacts-menu__contact _mail">info@mscards.ro</a>
							</div>
						</div>
					</div>
			</div>
				...
				<section class="breadcrums">
					<div class="breadcrums__container _container">
						<ul class="breadcrums__list">
							...
							<li class="breadcrums__item">
								<span class="breadcrums__link">NFC считыватель ACS ACR1252U III USB (NFC Forum Certified Reader </span>
							</li>
						</ul>
					</div>
				</section>
						...
						<div class="card__content">
							<div class="card__slider slider-card _gallery">
								<div class="slider-card__main main-slider-card _swiper">
									<a href="app/views/img/card-slider/main/01.png" class="main-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/main/01.webp" type="image/webp"><img src="app/views/img/card-slider/main/01.png" alt="Image"></picture>
									</a>
									<a href="app/views/img/card-slider/main/02.png" class="main-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/main/02.webp" type="image/webp"><img src="app/views/img/card-slider/main/02.png" alt="Image"></picture>
									</a>
									<a href="app/views/img/card-slider/main/01.png" class="main-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/main/01.webp" type="image/webp"><img src="app/views/img/card-slider/main/01.png" alt="Image"></picture>
									</a>
								...
								<div class="slider-card__thrumbs thrumbs-slider-card _swiper">
									<div class="thrumbs-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/thrumbs/01.webp" type="image/webp"><img src="app/views/img/card-slider/thrumbs/01.png" alt="Image"></picture>
									</div>
									<div class="thrumbs-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/thrumbs/02.webp" type="image/webp"><img src="app/views/img/card-slider/thrumbs/02.png" alt="Image"></picture>
									</div>
									<div class="thrumbs-slider-card__item">
										<picture><source srcset="app/views/img/card-slider/thrumbs/01.webp" type="image/webp"><img src="app/views/img/card-slider/thrumbs/01.png" alt="Image"></picture>
									</div>
							...
							<div class="card__info info-card" id = "wrapper_card_info">
								<div class="info-card__main main-info-card">
									<div class="main-info-card__head">
										<h2 class="main-info-card__title"><?php echo htmlspecialchars($item->title)?></h2>
										<p class="main-info-card__article">Артикул 000-212</p>
									</div>
									<p class="main-info-card__price">
										Цена <span class="main-info-card__price_value">
											1 шт. <?php echo htmlspecialchars($item->price)?>mdl
										</span> <span class="main-info-card__price_tax">(без TVA)</span>
									</p>
										...
										<li class="pricelist-main-info-card__item">
											<p>Купи 50 шт. по 
												<strong>
													...
													($item->price - ($item->price * ($item->discount()->from50 / 100))

													)
													?>mdl
												</strong> каждый и сэкономь 
												<strong>
												<?php echo htmlspecialchars($item->discount()->from50)?>%
												</strong>
											</p>
										</li>
										<li class="pricelist-main-info-card__item">
											<p>Купи 100 шт. по 
												<strong>
													<?php echo htmlspecialchars
													($item->price - ($item->price * ($item->discount()->from100 / 100))

													)
													?>mdl
												</strong> каждый и сэкономь 
												<strong>
												<?php echo htmlspecialchars($item->discount()->from100)?>%
												</strong>
											</p>
										</li>
										<li class="pricelist-main-info-card__item">
											<p>Купи 300 шт. по 
												<strong>
													<?php echo htmlspecialchars
													($item->price - ($item->price * ($item->discount()->from300 / 100))

													)
													?>mdl
												</strong> каждый и сэкономь 
												<strong>
												<?php echo htmlspecialchars($item->discount()->from300)?>%
												</strong>
											</p>
										</li>
										<li class="pricelist-main-info-card__item">
											<p>Купи 500 шт. по 
												<strong>
													<?php echo htmlspecialchars
													($item->price - ($item->price * ($item->discount()->from500 / 100))

													)
													?>mdl
												</strong> каждый и сэкономь 
												<strong>
												<?php echo htmlspecialchars($item->discount()->from500)?>%
												</strong>
											</p>
										</li>
										<li class="pricelist-main-info-card__item">
											<p>Купи 1000 шт. по 
												<strong>
													<?php echo htmlspecialchars
													($item->price - ($item->price * ($item->discount()->from1000 / 100))

													)
													?>mdl
												</strong> каждый и сэкономь 
												<strong>
												<?php echo htmlspecialchars($item->discount()->from1000)?>%
												</strong>
											</p>
										</li>
									</ul>
									...
									<div class="main-info-card__addition addition-main-info-card">
										<?php foreach ($item->smallOptions() as $option): ?>
											<div class="addition-main-info-card__item" id = "card_checkbox_input">
												<label class="addition-main-info-card__checkbox checkbox">
													...
													<span class="checkbox__text">
														<span>
															...
															<strong>+<?= htmlspecialchars($option['price']) ?>mdl</strong>
														</span>
													</span>
												</label>
											</div>
								...
								<div class="info-card__other other-info-card">
									<div class="other-info-card__actions">
										<div class="other-info-card__quantity">
											<div class="quantity" data-item-id="<?= htmlspecialchars($item->id) ?>">
												<div class="quantity__button quantity__button_minus"></div>
												<div class="quantity__input" id="card_quantity_input">
													<input 	autocomplete="off" 
															type="number" 
															name="form[]" 
															value="<?php echo htmlspecialchars($count_item) ?>">
												</div>
												<div class="quantity__button quantity__button_plus"></div>
											</div>
										</div>
										<form action="#" class="other-info-card__promo promo-other-info-card">
											<input type="text" name="promocode" placeholder="Промокод" class="promo-other-info-card__input">
								...
								<div class="tabs-card__blocks">
									<div class="tabs-card__block _tabs-block _active">
										<div class="tabs-card__text">
											<p><strong>NFC считыватель ACR 1252 U USB III</strong> сертифицирован международной организацией NFC Forum, разработан на основе технологии RFID 13,56 МГц и NFC стандарта ISO/IEC18092. Поддерживает стандарты ISO 14443 А, В, FeliCa, Mifare и 4 типа NFC меток.</p>
											<p>В NFC-считыватель бесконтактных смарт-карт и меток ACR1252 U USB III встроен SAM слот (Secure Access Module), который может использоваться вместе с SAM-картами для диверсификации ключей и взаимной аутентификации. Система обеспечивает высокий уровень безопасности при осуществлении бесконтактных транзакций. Возможность самостоятельного обновления прошивки считывателя позволяет использовать новейшие функции без необходимости его дополнительной модификации.</p>
											<p>Благодаря совместимости с протоколом CCID и набором спецификаций PC/SC, NFC считыватель ACR 1252 U USB III может взаимодействовать с различными приложениями и платформами, в том числе со смарт-постерами, которые используются в рекламных и маркетинговых целях, а также для связи с NFC-смартфонами.</p>
											<p>100% совместим с ID-паспортом Украины и ПО "UAID Reader".</p>
											<p><strong>Кроме базовой модели, ACR 1252U USB III доступен в таких модификациях модулей:</strong></p>
											<ul>
												<li><strong>ACM1252U-Z2</strong> – это небольшой модуль, разработанный на основе бесконтактной технологии 13,56 МГц для простой и компактной интеграции во встроенные системы.</li>
												<li><strong>ACM1252U-Z2</strong> – это небольшой модуль, разработанный на основе бесконтактной технологии 13,56 МГц для простой и компактной интеграции во встроенные системы.</li>
												<li><strong>ACM1252U-Z2</strong> – это небольшой модуль, разработанный на основе бесконтактной технологии 13,56 МГц для простой и компактной интеграции во встроенные системы.</li>
												<li><strong>ACM1252U-Z2</strong> – это небольшой модуль, разработанный на основе бесконтактной технологии 13,56 МГц для простой и компактной интеграции во встроенные системы.</li>
											</ul>
									...
									<div class="tabs-card__block _tabs-block">
										<div class="tabs-card__text">
											<p><strong>Характеристики NFC считыватель ACR 1252 U USB III</strong> сертифицирован международной организацией NFC Forum, разработан на основе технологии RFID 13,56 МГц и NFC стандарта ISO/IEC18092. Поддерживает стандарты ISO 14443 А, В, FeliCa, Mifare и 4 типа NFC меток.</p>
											<p>В NFC-считыватель бесконтактных смарт-карт и меток ACR1252 U USB III встроен SAM слот (Secure Access Module), который может использоваться вместе с SAM-картами для диверсификации ключей и взаимной аутентификации. Система обеспечивает высокий уровень безопасности при осуществлении бесконтактных транзакций. Возможность самостоятельного обновления прошивки считывателя позволяет использовать новейшие функции без необходимости его дополнительной модификации.</p>
											<p>Благодаря совместимости с протоколом CCID и набором спецификаций PC/SC, NFC считыватель ACR 1252 U USB III может взаимодействовать с различными приложениями и платформами, в том числе со смарт-постерами, которые используются в рекламных и маркетинговых целях, а также для связи с NFC-смартфонами.</p>
											<p>100% совместим с ID-паспортом Украины и ПО "UAID Reader".</p>
											<p><strong>Кроме базовой модели, ACR 1252U USB III доступен в таких модификациях модулей:</strong></p>
									...
									<div class="tabs-card__block _tabs-block">
										<div class="tabs-card__text">
											<p><strong> Документация NFC считыватель ACR 1252 U USB III</strong> сертифицирован международной организацией NFC Forum, разработан на основе технологии RFID 13,56 МГц и NFC стандарта ISO/IEC18092. Поддерживает стандарты ISO 14443 А, В, FeliCa, Mifare и 4 типа NFC меток.</p>
											<p>В NFC-считыватель бесконтактных смарт-карт и меток ACR1252 U USB III встроен SAM слот (Secure Access Module), который может использоваться вместе с SAM-картами для диверсификации ключей и взаимной аутентификации. Система обеспечивает высокий уровень безопасности при осуществлении бесконтактных транзакций. Возможность самостоятельного обновления прошивки считывателя позволяет использовать новейшие функции без необходимости его дополнительной модификации.</p>
											<p>Благодаря совместимости с протоколом CCID и набором спецификаций PC/SC, NFC считыватель ACR 1252 U USB III может взаимодействовать с различными приложениями и платформами, в том числе со смарт-постерами, которые используются в рекламных и маркетинговых целях, а также для связи с NFC-смартфонами.</p>
											<p>100% совместим с ID-паспортом Украины и ПО "UAID Reader".</p>
											<p><strong>Кроме базовой модели, ACR 1252U USB III доступен в таких модификациях модулей:</strong></p>
							...
							<div class="card__related related-card">
								...
								<div class="related-card__content">
									<div class="related-card__arrow related-card-arrow-prev">
										<picture><source srcset="app/views/img/icons/slider-arrow-prev.svg" type="image/webp"><img src="app/views/img/icons/slider-arrow-prev.svg" alt="Prev"></picture>
									</div>
									...
									<div class="related-card__arrow related-card-arrow-next">
										<picture><source srcset="app/views/img/icons/slider-arrow-next.svg" type="image/webp"><img src="app/views/img/icons/slider-arrow-next.svg" alt="Next"></picture>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="interested__head">
							...
							<div class="interested__arrows">
								<div class="interested__arrow interested-arrow-prev">
									<picture><source srcset="app/views/img/icons/arrow-2-left.svg" type="image/webp"><img src="app/views/img/icons/arrow-2-left.svg" alt="Prev"></picture>
								</div>
								<div class="interested__arrow interested-arrow-next">
									<picture><source srcset="app/views/img/icons/arrow-2-right.svg" type="image/webp"><img src="app/views/img/icons/arrow-2-right.svg" alt="Next"></picture>
								</div>
							</div>
						</div>
						<div class="interested__content">
							<div class="interested__slider _swiper">
								<div class="interested__product product">
									...
									<div class="product__body">
										<a href="#" class="product__name">NFC СЧИТЫВАТЕЛЬ ACS ACR1252U III USB (NFC FORUM CERTIFIED READER)scc</a>
										<div class="product__price price-product">
								...
								<div class="interested__product product">
									...
									<div class="product__body">
										<a href="#" class="product__name">Наклейки NFC с чипом MIFARE® DESFire® EV2 2K и защитой от контакта с металлом</a>
										<div class="product__price price-product">
				...
				<div class="request-popup__row">
					<button type="submit" class="request-popup__button">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M9.91202 11.9998H4.00002L2.02302 4.1348C2.01036 4.0891 2.00265 4.04216 2.00002 3.9948C1.97802 3.2738 2.77202 2.7738 3.46002 3.1038L22 11.9998L3.46002 20.8958C2.78002 21.2228 1.99602 20.7368 2.00002 20.0288C2.00204 19.9655 2.01316 19.9029 2.03302 19.8428L3.50002 14.9998" stroke="#2779F6" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						Отправить
					</button>
				</div>
...
<script src="app/views/js/my_js/card.js"></script>
	</body>
</html>